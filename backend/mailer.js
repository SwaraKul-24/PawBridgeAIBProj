    ...
    html: `
      <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
        ...
        <div style="padding: 30px; background-color: #fff;">
          ...
          <a href="http://localhost:5500/login" style="display: inline-block; padding: 12px 25px; margin-top: 20px; background-color: #38512F; color: #fff; text-decoration: none; border-radius: 5px; font-weight: bold;">Login Now</a>
